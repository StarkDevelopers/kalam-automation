...
import 'package:kalam_automation/screens/MyProfile/MyProfile.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            selected: currentScreen == MyProfile.routeName,
            selectedTileColor: Colors.grey[300],
            onTap: () => Navigator.of(context).pushNamed(MyProfile.routeName),
          ),
          ListTile(
            title: Text(
              'Logout',
